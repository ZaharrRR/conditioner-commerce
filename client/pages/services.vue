<template>
  <NuxtLayout name="page-layout">
    ...
    <div class="services-page">
      ...
      <SeoText
        text="Профессиональные услуги по установке и ремонту кондиционеров в Тюмени.
        Сертифицированные мастера с опытом работы более 10 лет. Монтаж
        сплит-систем любой сложности с гарантией качества. Обслуживание и чистка
        кондиционеров по доступным ценам."
      />
    </div>
  </NuxtLayout>
</template>
