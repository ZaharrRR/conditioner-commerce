  ...
  <NuxtLayout name="page-layout" class="privacy-policy">
    ...
    <div class="item">
      ...
      <p>
        ...
        предпринимаемые Болгарь Олегом Ивановичем (далее – Оператор).
      </p>
      <div class="sub-item">
        <p>
        ...
        <p>
          ...
          Оператор может получить о посетителях веб-сайта https://mywebsite.ru.
        </p>
      </div>
    </div>
    <div class="item">
      ...
      <div class="sub-item">
        ...
        <p>
          ...
          сети интернет по сетевому адресу https://mywebsite.ru;
        </p>
        <p>
    ...
    <div class="item">
      ...
      <div class="sub-item">
        <p>
          ...
          содержащимся на веб-сайте httpsː//mywebsite.ru; уточнение деталей
          заказа.
        </p>
        <p>
          ...
          электронной почты privacy@mywebsite.ru с пометкой «Отказ от
    ...
    <div class="item">
      ...
      <div class="sub-item">
        <p>
          ...
          специальные формы, расположенные на сайте https://mywebsite.ru.
    ...
    <div class="item">
      ...
      <div class="sub-item">
        ...
        <p>
          ...
          Оператора privacy@mywebsite.ru с пометкой «Актуализация персональных
          данных».
        </p>
        <p>
          ...
          Оператора privacy@mywebsite.ru с пометкой «Отзыв согласия на обработку
          персональных данных».
        </p>
      </div>
    </div>
    <div class="item">
      <h1>7. Трансграничная передача персональных данных</h1>
      <div class="sub-item">
        <p>
    ...
    <div class="item">
      ...
      <div class="sub-item">
        <p>
          ...
          Оператору с помощью электронной почты privacy@mywebsite.ru.
        </p>
        <p>
        ...
        <p>
          ...
          Интернет по адресу https://mywebsite.ru/privacy-ploicy/.
        </p>
      </div>
    </div>
  </NuxtLayout>
