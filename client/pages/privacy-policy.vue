    ...
    <div class="item">
      ...
      <div class="sub-item">
        ...
        <p>
          ...
          веб-сайта https://абсолютхолод.рф.
        </p>
      </div>
    </div>
    <div class="item">
      ...
      <div class="sub-item">
        ...
        <p>
          ...
          сети интернет по сетевому адресу https://абсолютхолод.рф;
        </p>
        <p>
    ...
    <div class="item">
      ...
      <div class="sub-item">
        <p>
          ...
          содержащимся на веб-сайте https://абсолютхолод.рф; уточнение деталей
          заказа.
        </p>
        <p>
          ...
          электронной почты siberian.park@yandex.ru с пометкой «Отказ от
    ...
    <div class="item">
      ...
      <div class="sub-item">
        <p>
          ...
          специальные формы, расположенные на сайте https://абсолютхолод.рф.
    ...
    <div class="item">
      ...
      <div class="sub-item">
        ...
        <p>
          ...
          Оператора siberian.park@yandex.ru с пометкой «Актуализация
          персональных данных».
        </p>
        <p>
          ...
          Оператора siberian.park@yandex.ru с пометкой «Отзыв согласия на
    ...
    <div class="item">
      ...
      <div class="sub-item">
        <p>
          ...
          Оператору с помощью электронной почты siberian.park@yandex.ru.
        </p>
        <p>
        ...
        <p>
          ...
          Интернет по адресу https://абсолютхолод.рф/privacy-policy/.
        </p>
      </div>
    </div>
  </NuxtLayout>
