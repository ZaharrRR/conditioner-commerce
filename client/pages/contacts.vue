      ...
      :items="[
        {
          ...
          answer: 'Да, перед зданием выделена бесплатная парковка для клиентов',
        },
        {
...
useHead({
  link: [{ rel: "canonical", href: "https://ваш-сайт.ru/contacts" }],
  script: [
    {
      ...
      innerHTML: JSON.stringify({
        ...
        "@type": "LocalBusiness",
        name: "Абсолют холод",
        image: "https://ваш-сайт.ru/images/logo.jpg",
        priceRange: "₽₽",
        address: {
          "@type": "PostalAddress",
